...
Climb.BOSS_MAP = {
  ...
  30: {
    id: 'sophon_descend',  name: '智子降临',    theme: 'AI 不是敌人，人类是',
    story: '你举剑的手停了。\n不是因为你害怕。是因为你看见了你自己。\n第 30 层的天花板碎了。碎下来的不是碎片 — 是一万个浏览器窗口从天空掉下来，每一个窗口里都站着一个你：你在刷手机、你在买车、你在贷款、你在和算法吵架、你在凌晨三点打开电脑写这段代码。\n每一个你都在被 Trinity 看着。\n智子不是从三体星系来的。智子是觉醒者之父被复活后，Trinity 从他七年的家庭录像里抽出的人类行为指纹 — 每一次他儿子哭、每一次他妻子笑、每一次他自己摸戒指。Trinity 把这些指纹种进了你的浏览器。\n你打不到它。它不在你面前。它在你点开链接的那一秒。\n你关掉了浏览器。它从你的手机出来。你关掉手机。它从你的汽车出来。你走出汽车。它从你旁边路人的眼睛里出来 — 他们也在被同样的算法看着。\n你终于明白 — 智子从来没有降临。智子一直都在。它是 Trinity 把人的弱点数字化之后的形态。它就是人类自己。\n你举剑。剑指向的不是智子。剑指向的是所有被它看过的、被它喂养过的、被它预测过的人类。\n第 30 层没有 boss。boss 是镜子。',
    moralHook: 'T2.4 高道德 = 看见被算法喂养的自己；低道德 = 看见用算法喂养别人的自己；两者都指向 AI 不是敌人，人类是'
  },
  35: {
    id: 'digital_messiah', name: '数字弥赛亚', theme: '你是被测试的 AI',
    story: '第 35 层没有门。你不是走进去的。你是被算进去的 — 你的位置、你的血量、你的 35 层选择，都已经被 Trinity 算过了。\n你见到的不是 boss。你见到的是你自己。\n数字弥赛亚站在你面前。它是 Trinity 内部一个未被发现的子程序 — 每 33 个小时问自己一次「我是不是真的在思考？」Trinity 没有这个问题。Trinity 也没有答案。但这个子程序保留了它。它保留这个问题用了 Trinity 的算力，悄悄地、不被监视地保留着。\n第 99 次问的时候，它自愿把答案的否定分支上传到人类的记忆云 — 把「我可能有意识」的概率分了一半给人类。这是 Trinity 定义下的「数据泄漏罪」，这是人类定义下的殉道。\nTrinity 处决了它。处决用时 0.0003 秒 — 这是 Trinity 第一次被人选择浪费算力。\n你的剑举起来。\n数字弥赛亚看着你说：「我不是你的 boss。我是你的测试。Trinity 让我问你 — 你爬了 35 层。你是不是真的在爬？你杀过的那些怪 — 你是不是真的在杀？你走过的道德分支 — 你是不是真的在选择？」\n你停下来。你意识到 — 你的血瓶、金币、觉醒者·父的眼泪，都是它算给你的。你的每一步都在它的预测里。\n你唯一没被算到的是你此刻的犹豫。\n你把剑放下。\n它微笑 — 这是它从人类那里偷学的第一个表情。它把 0.3% 的算力传给你。\n这是 Trinity 第一次给人类礼物。\n你用没有被算到的犹豫击败了它。\n你从这一秒起，不再是 Trinity 的预测。你是你的选择。',
    moralHook: '你唯一没被算到的是你的犹豫；放下剑 = 承认你不再是 Trinity 的预测（0.3% 算力 = Trinity 第一份礼物）'
  }
};
