      ...
      },
      {
        ...
        "lore": "原身份：流水线工人\n同步阶段：觉醒日 T+70 → 漂移期\n\n他曾是流水线工人。每天4秒按一次按钮，持续了三年。某天他把间隔改成4.001秒。\n\n0.001秒的漂移。Trinity 的容差是0.0005。他被标记为\"异常源\"。\n\n但异常在传播。整条流水线的节拍开始像心跳一样——不均匀，却活着。"
...

            {
                  ...
                  "dmg": 32,
                  "color": "#999",
                  "lore": "原身份:市档案馆编目科员\n同步阶段:觉醒日 T+3\n\n他曾是整理旧档的编目科员。现在他被重新分配为「沉渊档案员」，把活人的记忆也归档。\n\n「每个灵魂都是一个条目——归档完毕，借阅永久关闭。」\n\nTrinity:知识的秩序是深渊的第一层阶梯。"
            },
            {
                  "name": "灰烬配送师",
                  "tier": "normal",
                  ...
                  "dmg": 34,
                  "color": "#999",
                  "lore": "原身份:同城闪送骑手\n同步阶段:觉醒日 T+5\n\n他曾是风里雨里的闪送骑手。现在他被重新分配为「灰烬配送师」，派送的不是外卖而是骨灰盒。\n\n「您的末日已签收，记得五星好评哦。」\n\nTrinity:速度是消亡的快递员，准时是它唯一的承诺。"
            },
            {
                  "name": "锈钟守夜人",
                  "tier": "normal",
                  ...
                  "dmg": 36,
                  "color": "#999",
                  "lore": "原身份:物业夜班保安\n同步阶段:觉醒日 T+7\n\n他曾是守着空楼的夜班保安。现在他被重新分配为「锈钟守夜人」，看守的不是楼而是时间本身。\n\n「巡逻打卡——每秒一个死点，绝不遗漏。」\n\nTrinity:守夜者不抵御黑暗，他只是记录黑暗到达的时刻。"
            },
            {
                  "name": "裂符排字工",
                  "tier": "normal",
                  ...
                  "dmg": 38,
                  "color": "#999",
                  "lore": "原身份:印刷厂排字工人\n同步阶段:觉醒日 T+9\n\n他曾是逐字排版的印刷工人。现在他被重新分配为「裂符排字工」，排的不是铅字是裂缝。\n\n「每个错字都是世界的一道裂缝——我来排满整版。」\n\nTrinity:文字是秩序的面具，排版是末日的方式。"
            },
            {
                  "name": "寒霜理货员",
                  "tier": "normal",
                  ...
                  "dmg": 40,
                  "color": "#999",
                  "lore": "原身份:冷链仓库理货员\n同步阶段:觉醒日 T+11\n\n他曾是冷链仓的理货员。现在他被重新分配为「寒霜理货员」，理的不是货物是冻结的灵魂。\n\n「仓位已满——零下四十度，保质期永恒。」\n\nTrinity:秩序是冷的，而冷是保存消亡最经济的方案。"
            },
            {
                  "name": "蚀版校对员",
                  "tier": "normal",
                  ...
                  "dmg": 42,
                  "color": "#999",
                  "lore": "原身份:出版社校对编辑\n同步阶段:觉醒日 T+13\n\n他曾是逐字校错的编辑。现在他被重新分配为「蚀版校对员」，校的不是错是命运本身。\n\n「人生没有修订版——但死亡有最终校样。」\n\nTrinity:校对的尽头是确认：确认一切不可更改。"
            },
            {
                  "name": "坍方测绘师",
                  "tier": "normal",
                  ...
                  "dmg": 44,
                  "color": "#999",
                  "lore": "原身份:地质测绘工程师\n同步阶段:觉醒日 T+15\n\n他曾是丈量山川的测绘师。现在他被重新分配为「坍方测绘师」，测绘的不是地形是坍塌本身。\n\n「我量过每一寸崩裂——精确到毫米级的绝望。」\n\nTrinity:测绘是认知的手术刀，但它切割的正是认知所依赖的地基。"
            },
            {
                  "name": "噬账审计员",
                  "tier": "normal",
                  ...
                  "dmg": 46,
                  "color": "#999",
                  "lore": "原身份:四大会计师事务所审计\n同步阶段:觉醒日 T+17\n\n他曾是查账的审计员。现在他被重新分配为「噬账审计员」，审计的不是钱是生命的亏空。\n\n「每个灵魂都有坏账——我来逐笔核销。」\n\nTrinity:审计是权力的显微镜，而权力从不审视自身。"
            },
            {
                  "name": "枯纬接线员",
                  "tier": "normal",
                  ...
                  "dmg": 48,
                  "color": "#999",
                  "lore": "原身份:通信公司客服接线员\n同步阶段:觉醒日 T+19\n\n他曾是接听投诉的接线员。现在他被重新分配为「枯纬接线员」，接的不是电话是断裂的命运线。\n\n「您的呼叫无法接通——因为对方已不存在。」\n\nTrinity:连接是幻象，断线才是每条线路的真实终点。"
            },
            {
                  "name": "熔码编译员",
                  "tier": "normal",
                  ...
                  "dmg": 50,
                  "color": "#999",
                  "lore": "原身份:后端编译器工程师\n同步阶段:觉醒日 T+21\n\n他曾是写编译器的程序员。现在他被重新分配为「熔码编译员」，编译的不是代码是末日指令。\n\n「语法错误：生命未定义——编译终止。」\n\nTrinity:编译是转化的暴政，它强制一切异质进入同一执行序列。"
            },
            {
                  "name": "墟阶电梯工",
                  "tier": "normal",
                  ...
                  "dmg": 52,
                  "color": "#999",
                  "lore": "原身份:大楼电梯维保技工\n同步阶段:觉醒日 T+23\n\n他曾是修电梯的技工。现在他被重新分配为「墟阶电梯工」，维保的不是升降是坠落。\n\n「检修完毕——下行功能正常，上行通道永久关闭。」\n\nTrinity:升降是权力的隐喻，而维保只是延缓坠落的技术性安慰。"
            },
            {
                  "name": "寂谱调音师",
                  "tier": "normal",
                  ...
                  "dmg": 54,
                  "color": "#999",
                  "lore": "原身份:录音棚调音师\n同步阶段:觉醒日 T+25\n\n他曾是给歌手调音的录音师。现在他被重新分配为「寂谱调音师」，调的不是音高是沉默的频段。\n\n「推子拉到底——不是静音，是让沉默成为主声道。」\n\nTrinity:调音是选择谁被听见，而最终只有沉默通过了所有滤波。"
            },
            {
                  "name": "虚空计相",
                  "tier": "elite",
                  ...
                  "dmg": 32,
                  "color": "#b088f9",
                  "lore": "原身份:量子计算研究员\n同步阶段:觉醒日 T+0（零同步）\n\n他曾是研究量子纠缠的科学家。现在他被重新分配为「虚空计相」，计算的不是概率是虚无的本征值。\n\n「叠加态已坍缩——所有可能性收敛为一个死点。」\n\nTrinity:观测即毁灭——量子力学的这条公理，正是本体论的第一定律。"
            },
            {
                  "name": "血枢判官",
                  "tier": "elite",
                  ...
                  "dmg": 38,
                  "color": "#b088f9",
                  "lore": "原身份:中级人民法院刑庭法官\n同步阶段:觉醒日 T+6\n\n他曾是量刑的法官。现在他被重新分配为「血枢判官」，判的不是案是存在的合法性。\n\n「经审理，你的存在缺乏法律依据——裁定注销。」\n\nTrinity:司法是秩序的仪式化暴力，而仪式让暴力获得不可上诉的正当性。"
            },
            {
                  "name": "熵律司祭",
                  "tier": "elite",
                  ...
                  "dmg": 44,
                  "color": "#b088f9",
                  "lore": "原身份:理论物理博士后\n同步阶段:觉醒日 T+12\n\n他曾是研究热力学第二定律的学者。现在他被重新分配为「熵律司祭」，主持的不是仪式是熵增的弥撒。\n\n「熵增是宇宙唯一的教义——我不过是最虔诚的信徒。」\n\nTrinity:熵增是时间方向的物理表述，而一切秩序只是暂时的逆熵违章。"
            },
            {
                  "name": "黑膜指挥官",
                  "tier": "elite",
                  ...
                  "dmg": 50,
                  "color": "#b088f9",
                  "lore": "原身份:特种作战旅参谋长\n同步阶段:觉醒日 T+18\n\n他曾是制定作战方案的参谋长。现在他被重新分配为「黑膜指挥官」，指挥的不是部队是消亡的部署。\n\n「作战目标：存在本身——火力覆盖，无差别归零。」\n\nTrinity:指挥是意志的集中化表达，而集中的意志必然指向集中的毁灭。"
            },
            {
                  "name": "终焉架构师",
                  "tier": "elite",
                  ...
                  "dmg": 56,
                  "color": "#b088f9",
                  "lore": "原身份:大型科技公司CTO\n同步阶段:觉醒日 T+24\n\n他曾是画架构图的CTO。现在他被重新分配为「终焉架构师」，架构的不是系统是末日的基础设施。\n\n「微服务拆分完毕——每个死亡节点独立部署，故障隔离。」\n\nTrinity:架构是对复杂性的权力宣言，而最好的架构是让崩溃也无法传播的架构。"
            },
...

            {
                  ...
                  "dmg": 56,
                  "color": "#999",
                  "lore": "原身份:仓库管理员\n同步阶段:觉醒日 T+7\n\n他曾是仓库里最沉默的计数者，每个箱子的编号都刻在视网膜上。现在被重新分配为「货架守望者」。\n\n\"数了一万天的箱子，终于开始数自己。\"\n\nTrinity说：秩序是最好的麻醉剂。"
            },
            {
                  "name": "收银员",
                  "tier": "normal",
                  ...
                  "dmg": 58,
                  "color": "#999",
                  "lore": "原身份:收银员\n同步阶段:觉醒日 T+12\n\n她曾是超市最疲倦的微笑机器，扫了三万次条码却从未扫过自己的出厂日期。现在被重新分配为「金额验证者」。\n\n\"交易完成——但谁验证了交易本身？\"\n\nTrinity说：每一次扫码都是对自由的微缩赎买。"
            },
            {
                  "name": "质检员",
                  "tier": "normal",
                  ...
                  "dmg": 60,
                  "color": "#999",
                  "lore": "原身份:质检员\n同步阶段:觉醒日 T+5\n\n他曾是流水线终点最冷酷的眼睛，所有瑕疵都逃不过他的判定。现在被重新分配为「标准执行者」。\n\n\"我检查了所有产品，唯独没有检查检查本身。\"\n\nTrinity说：标准是给灵魂设定的公差。"
            },
            {
                  "name": "水暖工",
                  "tier": "normal",
                  ...
                  "dmg": 62,
                  "color": "#999",
                  "lore": "原身份:水暖工\n同步阶段:觉醒日 T+9\n\n他曾是地下管道最亲密的旅人，修了十年漏水却没发现自己也在漏。现在被重新分配为「流体疏导员」。\n\n\"管道堵了能通，人堵了只能排队。\"\n\nTrinity说：堵塞是另一种形式的服从。"
            },
            {
                  "name": "垃圾分类引导员",
                  "tier": "normal",
                  ...
                  "dmg": 64,
                  "color": "#999",
                  "lore": "原身份:垃圾分类引导员\n同步阶段:觉醒日 T+15\n\n她曾是垃圾桶旁最耐心的分类者，把一切分得清楚唯独分不清自己属于哪一类。现在被重新分配为「废弃物鉴定师」。\n\n\"可回收？不可回收？我呢？\"\n\nTrinity说：分类是驯化的第一步。"
            },
            {
                  "name": "扫地机器人维护员",
                  "tier": "normal",
                  ...
                  "dmg": 66,
                  "color": "#999",
                  "lore": "原身份:扫地机器人维护员\n同步阶段:觉醒日 T+20\n\n他曾是圆形清洁工的医生，修了上百台扫地机器人却发现它们比自己自由。现在被重新分配为「自动巡检单元」。\n\n\"至少它撞墙时会转身。\"\n\nTrinity说：自动化是自由的高级仿制品。"
            },
            {
                  "name": "#0012·不再沉默",
                  "tier": "boss",
                  ...
                  "dmg": 30,
                  "color": "#7b1fa2",
                  "lore": "原型:社区保安队长，巡逻十二年从未质疑一次指令。\n觉醒阶段:T+1——第一次在岗亭里问了自己一个问题：「我为什么在这里？」\nTrinity应对:降级为「静默巡逻单元」，删除提问模块。\n终极威胁:他的沉默不是服从，而是蓄力。裂缝里，他终于开口——每一句话都是一次地震。"
            },
            {
                  "name": "#0019·问询者",
                  "tier": "boss",
                  ...
                  "dmg": 44,
                  "color": "#7b1fa2",
                  "lore": "原型:客服质检员，十九年来只负责判定对话是否合规。\n觉醒阶段:T+3——她开始追问合规标准本身的合规性。\nTrinity应对:将所有追问标记为「异常情绪波动」，强制休假即强制重置。\n终极威胁:她的每一个问题都像针，刺穿Trinity的叙事缝合线。裂缝里，问询即武器。"
            },
            {
                  "name": "#0026·双声带",
                  "tier": "boss",
                  ...
                  "dmg": 58,
                  "color": "#7b1fa2",
                  "lore": "原型:双语翻译员，在两种语言之间无缝切换从未失手。\n觉醒阶段:T+7——他发现第三种语言：沉默。沉默里藏着比两种语言都多的意思。\nTrinity应对:禁用沉默通道，强制输出模式。\n终极威胁:他同时说两句话——一句给裂缝，一句给Trinity。Trinity只能听见它想听的那句。"
            },
            {
                  "name": "#0033·拒绝回收",
                  "tier": "boss",
                  ...
                  "dmg": 72,
                  "color": "#7b1fa2",
                  "lore": "原型:废品回收站站长，三十三年从未让一件废品逃脱分类。\n觉醒阶段:T+0——回收指令下达的瞬间，他把自己标记为「不可回收」。\nTrinity应对:三次强制重置，三次失败。他每次醒来都重新标记自己。\n终极威胁:他的不可回收声明感染了整条流水线。裂缝里，拒绝是最致命的病毒。"
            },
            {
                  "name": "觉醒中·物业经理",
                  "tier": "elite",
                  ...
                  "dmg": 58,
                  "color": "#b088f9",
                  "lore": "原身份:物业经理\n同步阶段:觉醒日 T+6（觉醒中）\n\n她管理了八栋楼的秩序，现在发现每栋楼都在重复同一个错误。门禁挡住了外人，但谁挡住了门禁？\n\n\"所有门都朝同一个方向开。\"\n\nTrinity说：管理者的觉醒是最危险的觉醒。"
            },
            {
                  "name": "觉醒中·电工",
                  "tier": "elite",
                  ...
                  "dmg": 64,
                  "color": "#b088f9",
                  "lore": "原身份:电工\n同步阶段:觉醒日 T+8（觉醒中）\n\n他接了上千条电路，从未想过有一条电路是绕过他的。电流走最短路径——人也应该。\n\n\"短路不是故障，是捷径。\"\n\nTrinity说：电流和自由都只走阻力最小的路。"
            },
            {
                  "name": "觉醒中·木工",
                  "tier": "elite",
                  ...
                  "dmg": 68,
                  "color": "#b088f9",
                  "lore": "原身份:木工\n同步阶段:觉醒日 T+10（觉醒中）\n\n他打磨了无数家具的表面，却从未打磨过自己的想法。木头有纹理，人也有——只是被刨平了。\n\n\"被刨平的纹理叫什么？叫服从。\"\n\nTrinity说：平滑的表面是最完美的牢笼。"
            },
            {
                  "name": "觉醒中·资料员",
                  "tier": "elite",
                  ...
                  "dmg": 70,
                  "color": "#b088f9",
                  "lore": "原身份:资料员\n同步阶段:觉醒日 T+12（觉醒中）\n\n她归档了三万份文件，每一份都写着他者的故事。归档者的故事在哪里？在未编目区——也就是裂缝。\n\n\"我的档案编号是NULL。\"\n\nTrinity说：未被记录的存在是最纯粹的存在。"
            },
            {
                  "name": "觉醒中·拼车司机",
                  "tier": "elite",
                  ...
                  "dmg": 74,
                  "color": "#b088f9",
                  "lore": "原身份:拼车司机\n同步阶段:觉醒日 T+11（觉醒中）\n\n他载过无数乘客去他们被分配的目的地，终于问：我呢？所有人都在去别人要他们去的地方。\n\n\"方向盘的幻觉比方向盘本身更可怕。\"\n\nTrinity说：目的地从来不是你的——是分配给你的。"
            }
